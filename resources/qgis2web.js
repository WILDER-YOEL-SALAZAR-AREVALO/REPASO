...
map.getView().fit([-9228100.519819, -1032174.362494, -8168606.903115, -314265.638736], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Unidades Geologicas de Cajamarca</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (28 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '@Wilder Yoel Salazar Arévalo';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_GEOLOGIA_CAJAMARCA_1,
    colName: 'SIMBOLO_',
    zoom: 10,
    collapsed: true,
    map: map
